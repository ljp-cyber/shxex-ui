<template>
  <el-table :border="true" :data="data" v-loading="table.loading" :stripe="table.stripe" @selection-change="handleSelectionChange">
    <template v-for="item in curHeader">
    	<!-- 选择列 -->
      <el-table-column type="selection" :fixed="item.fixed" :width="item.width" v-if="item.type == 'selection'">
      </el-table-column>
      <!-- 选项列 -->
